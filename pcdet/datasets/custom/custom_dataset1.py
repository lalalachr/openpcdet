...
class CustomDataset(DatasetTemplate):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        ap_result_str, ap_dict = custom_eval.get_official_eval_result(eval_gt_annos, eval_det_annos, class_names)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            data_path=ROOT_DIR / 'mydata' / 'custom',
            save_path=ROOT_DIR / 'mydata' / 'custom'
